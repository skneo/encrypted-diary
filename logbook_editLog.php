...
<body>
    ...
    if (isset($_GET['editLog'])) {
        ...
        $id = $row['id'];
        echo "<center>
            <a href='logbook_home.php' class='btn btn-primary mb-2 mt-3'><- All Logs</a>
            </center>
            <div class='container my-3'>
                <h5>Edit Log ID $id</h5>
                <form action='logbook_home.php' method='post'>
                    ...
                    <label class='form-label mt-3'>Log Body</label>
                    <textarea class='form-control mt-3' name='editLog' id='editLog' cols='30' rows='10'>$logBody</textarea>
                    <button type='submit' class='btn btn-primary mt-3' name='id' value='$id'>Save Log</button>
                </form>
            </div>";
        mysqli_close($con);
    }
